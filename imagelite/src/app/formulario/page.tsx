...
import { Button, Input, Template, RenderIf, useNotification, FieldError, AuthenticatedPage } from "@/components"
                ...
                <section className="flex flex-col items-center justify-center my-5">
                    ...
                    <form onSubmit={formik.handleSubmit}>
                        ...
                        <div className="mt-5 flex items-center justify-between gap-x-4">
                            <Link href="/galeria">
                                <Button style='bg-red-500 hover:bg-red-300' type="button" label="Cancel"></Button>
                            </Link>
                            <Button style='bg-blue-500 hover:bg-blue-300' type="submit" label="Save"></Button>
                        </div>
